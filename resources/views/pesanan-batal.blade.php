...
@section('title') | User | Pesanan-batal @endsection
@section('content')
<div class="container">
  <!-- <div class="card-body"> -->
  <div class="row justify-content-center">
    <div class="col-md-10">
      ...
      <div class="row">
        <div class="col-md-6">
          <h3>Pesanan yang dibatalkan</h3>
        </div>
        <div class="col-md-6">
          <form action="{{route('user.pesanan_batal')}}" method="get">
      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody>
            @if($data->isEmpty())
            <tr>
              <td class="text-danger text-center" colspan="8">Belum ada pesanan yang dibatalkan !</td>
            </tr>
            @else
            @php
            $no = 1;
