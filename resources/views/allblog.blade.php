...
@section('content')
<div class="container ">
  <h2 class="justify-content-center text-center"><i class="fa fa-blog"></i> Artikel & Tips</h2>
  <br>
  ...
  @if($data->isEmpty())
  <h4 class="text-center justify-content-center text-muted">Blog tidak ditemukan !</h4>
  @else
  <div class="row mb-2">
